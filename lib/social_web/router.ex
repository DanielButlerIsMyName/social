defmodule SocialWeb.Router do
  ...
  scope "/", SocialWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{SocialWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", SocialWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{SocialWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", SocialWeb do
    ...
    live_session :current_user,
      on_mount: [{SocialWeb.UserAuth, :mount_current_user}] do
